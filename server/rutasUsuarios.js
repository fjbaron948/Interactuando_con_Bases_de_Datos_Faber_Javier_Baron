...
Router.get('/demo', function(req, res) {
  Usuarios.find({user: req.query.user}).count({}, function(err, count) { //Verificar si exste el usuario DEMO
    if(count>0){ //Si el registro es mayor a 0
        res.send("Utilice los siguientes datos para ingresar: </br>usuario: fjbaron948 | password: 123456 </br>usuario: fjbaron | password: fjbaron123") //Mostrra mensaje con los datos de los usuarios predeterminados
    }else{
